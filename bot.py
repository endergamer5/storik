...
def inlin(c):
    ...
    if c.data=='otk':
        bot.edit_message_text(
			...
			"\n======================================"
			"\nТелеграм канал со всей информацией по поводу бота t.me/infostoreqiwi"
			"\nСвязь со мной @voprosisuda"
			"\nПосле покупки кошелька вы можете написать отзыв мне в личку и получить скидку 40% на следующий кошелек!",
            parse_mode="markdown",
            reply_markup=nazad ())
    elif c.data=='glm':
        bot.edit_message_text(
